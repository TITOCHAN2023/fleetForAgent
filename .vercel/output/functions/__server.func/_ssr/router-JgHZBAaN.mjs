...
import { n as auth } from "./server-D0fzTmWW.mjs";
import { t as TriangleAlert } from "../_libs/lucide-react.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-JgHZBAaN.js
var router_JgHZBAaN_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function AppErrorComponent({ error }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "bg-bg text-fg flex min-h-svh flex-col items-center justify-center gap-3 px-6 text-center",
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: error.message || "未预期的错误。试着重新加载。"
			})
		]
	});
}
...
var styles_default = "/assets/styles-CJLOOZow.css";
var APP_NAME = "KEEL";
var Route$4 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "多机统筹中枢：清单、选一台、再操作。设备只连出。"
			}
		],
		links: [
			{
...
//#endregion
export { getRouter, router_JgHZBAaN_exports as t };
