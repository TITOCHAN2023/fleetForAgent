...
`fleet.ginfo.cc` is deployed by `.github/workflows/deploy-hub.yml`, which bakes `SOURCE_COMMIT=$GITHUB_SHA`. Anyone can `curl https://fleet.ginfo.cc/source` and compare that SHA to this repo. Details: [docs/en/trust.md](../../docs/en/trust.md).
